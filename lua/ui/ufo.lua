...
{
  {
      ...
      keys = {
        ...
        { "zr", function() require("ufo").openFoldsExceptKinds() end, mode = "n", desc = "Open folds except kinds" },
        { "zm", function() require("ufo").closeFoldsWith() end,       mode = "n", desc = "Close folds with" },
        { "zK", function()
